...
{
    // Runs for every internal HttpClient call made by the gateway.
    ...
    )
    {
        ...
        {
            // Make downstream tracing unambiguous by replacing any existing correlation header.
        ...
        try
        {
            // base.SendAsync continues through resilience handlers and eventually sends the HTTP request.
